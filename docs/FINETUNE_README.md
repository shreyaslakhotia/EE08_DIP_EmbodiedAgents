...
│   └── howtoaccessgpu.md               # GPU cluster access guide
...
│   ├── 04_export_model.py              #   Step 4: GGUF export + Ollama setup
│   ├── 05_evaluate_test_accuracy.py    #   Step 5: Test evaluation
...
├── prototypes/                        # Earlier prototype code
│   ├── phase0_streamlit/              #   Streamlit cloud-API prototype
│   ├── qwen3_vl_4b/                   #   Stage 1 & 2 milestones
│   └── modular_codes/                 #   Camera, PIR, Ollama tests
├── tests/                             # Hardware test scripts
├── data/
│   ├── emotion_dataset/               # [gitignored] Raw FER-2013 (48×48)
│   ├── emotion_processed/             # [gitignored] Preprocessed 224×224 RGB
...
└── checkpoints/                       # [gitignored] Download from OneDrive
    └── qwen3vl_studybuddy/
        ...
        └── export/
            ├── Modelfile
            ├── run_studybuddy.py
            └── studybuddy_gguf/       #   GGUF weights (~3.1 GB)
```
